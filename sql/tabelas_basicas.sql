...
CREATE TABLE IF NOT EXISTS snb_endereco (
  ...
  fg_principal enum('S','N') NOT null,
...
(1, 'admin', 1, 'S', 'd033e22ae348aeb5660fc2140aec35850c4da997');
...
INSERT INTO snb_menu (id, cod_aplicacao, nm_tabela, nm_view, nm_menu, nm_pagina, fg_ativa, sequencia, id_menu_proximo, id_modulo) VALUES
(1, 'BAS001', 'snb_unid_fed', null, 'UF', null, 'S', 1, null, 1),
(2, 'BAS002', 'snb_cidade', null, 'Cidade', null, 'S', 2, null, 1),
(3, 'BAS003', 'snb_tp_logradouro', null, 'Tipo de Logradouro', null, 'S', 3, null, 1),
(4, 'PES001', 'snb_tp_pessoa', null, 'Tipo de Pessoa', null, 'S', 4, null, 1),
(5, 'PES002', 'snb_pessoa', null, 'Pessoa', null, 'S', 5, 6, 2),
(6, 'PES003', 'snb_filial', 'vsnb_filial', 'Filial', null, 'S', 6, 7, 2),
(7, 'PES004', 'snb_endereco', 'vsnb_endereco', 'Endereço', null, 'S', 7, 8, 2),
(8, 'PES005', 'snb_telefone', 'vsnb_telefone', 'Telefone', null, 'S', 8, 9, 2),
(9, 'PES006', 'snb_end_eletronico', 'vsnb_end_eletronico', 'Endereço Eletrônico', null, 'S', 9, null, 2),
(10, 'SIS001', 'snb_menu', 'vsnb_menu', 'Menu', null, 'S', 9, null, 3),
(11, 'SIS002', 'snb_usuario', 'vsnb_usuario', 'Usuário', null, 'S', 10, null, 3),
(12, 'SIS003', 'snb_autorizacao', 'vsnb_autorizacao', 'Autorização ao Sistema', null, 'S', 11, null, 3),
(13, 'SIS004', 'snb_modulo', null, 'Módulo Sistema', null, 'S', 12, null, 3),
(14, 'SIS005', 'snb_dicionario', null, 'Dicionário', null, 'S', 13, null, 3),
(15, 'SIS006', 'snb_dicionario_detalhe', 'vsnb_dicionario_detalhe', 'Dicionário Detalhe', null, 'S', 14, null, 3);
...
values
(1,2,'ID','Id','NUMÉRICO','SIM',1,null,5,5,null,null,null,'SIM',null),
(2,2,'ID_DICIONARIO','Id Dicionário','NUMÉRICO','SIM',2,null,5,5,null,1,null,'NÃO',null),
(3,2,'NOME_COLUNA','Nome Coluna','TEXTO','SIM',3,null,30,50,null,null,null,'NÃO',null),
...
(6,2,'TIPO_DADO','Tipo Dado','ENUM','SIM',6,null,10,10,'SENHA,NUMÉRICO,DATA,ARQUIVO,TEXTO,TEXTO LONGO,LISTA VALOR,ENUM',null,null,'NÃO',null),
...
(11,2,'ID_DICIONARIO_LOV','Tabela Ref.','LISTA VALOR','SIM',11,null,10,10,null,1,null,'NÃO',null),
...
(15,2,'HINT_CAMPO','Hint Campo','TEXTO LONGO','SIM',15,null,100,1000,null,null,null,'NÃO',null),
(16,1,'ID','Id','NUMÉRICO','SIM',1,0,4,4,null,null,null,'SIM',null),
(17,1,'NOME_TABELA','Nome Tabela','TEXTO','SIM',2,null,30,60,null,null,null,'NÃO',null),
(18,1,'CAMPO_ID','Campo Id','TEXTO','SIM',3,null,30,60,null,null,null,'NÃO',null),
(19,1,'CAMPO_DESCRICAO','Campo Descrição','TEXTO','SIM',4,null,30,60,null,null,null,'NÃO',null);
