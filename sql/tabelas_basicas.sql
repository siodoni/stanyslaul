...
CREATE TABLE IF NOT EXISTS snb_dicionario_detalhe (
  ...
  tipo_dado enum('TEXTO','TEXTO LONGO','NUMÉRICO','DATA','DATA HORA','HORA','LISTA VALOR','ENUM','SENHA','ARQUIVO') NOT NULL,
...
(6, 2, 'tipo_dado',             'Tipo Dado', '6.00', 'ENUM', 10, 10, NULL, NULL, NULL, 'TEXTO,TEXTO LONGO,NUMÉRICO,DATA,DATA HORA,HORA,LISTA VALOR,ENUM,SENHA,ARQUIVO', 'SIM', 'NÃO', NULL),
...
(13, 2, 'fg_obrigatorio',       'Obrigatório?', '13.00', 'ENUM', 10, 10, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
(14, 2, 'fg_auto_incremento',   'Auto Incremento?', '14.00', 'ENUM', 10, 10, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
...
(33, 5, 'fg_principal',         'Endereço Principal?', '4.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*snb_endereco*/
...
(42, 6, 'fg_principal',         'Endereço Principal?', '10.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*snb_filial*/
...
(67, 10, 'sexo',                'Sexo', '6.00', 'ENUM', 9, 9, NULL, NULL, NULL, 'Masculino,Feminino', 'NÃO', 'NÃO', NULL),
...
(75, 11, 'fg_principal',        'Telefone Principal?', '6.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*snb_tp_logradouro*/
...
(100, 17, 'tipo_dado',          'Tipo Dado', '6.00', 'ENUM', 11, 11, NULL, NULL, NULL, 'TEXTO,TEXTO LONGO,NUMÉRICO,DATA,DATA HORA,HORA,LISTA VALOR,ENUM,SENHA,ARQUIVO', 'SIM', 'NÃO', NULL),
(101, 17, 'fg_obrigatorio',     'Obrigatório?', '7.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
(102, 17, 'fg_auto_incremento', 'Auto Incremento?', '8.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*vsnb_end_eletronico*/
...
(108, 18, 'fg_principal',       'Endereço Principal?', '6.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*vsnb_endereco*/
...
(122, 19, 'fg_principal',       'Endereço Principal?', '14.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*vsnb_filial*/
...
(132, 20, 'sexo',               'Sexo', '10.00', 'ENUM', 9, 9, NULL, NULL, NULL, 'Masculino,Feminino', 'NÃO', 'NÃO', NULL),
...
(152, 22, 'fg_principal',       'Telefone Principal?', '8.00', 'ENUM', 3, 3, NULL, NULL, NULL, 'NÃO,SIM', 'SIM', 'NÃO', NULL),
/*vsnb_usuario*/
